...
public class GameScene: SKScene {
    ...
    var isFadingInChange = SKAction()
    
    //sequences
    var cursorSequence1 = SKAction()
    var cursorSequence2 = SKAction()
    var cursorSequence3 = SKAction()
    ...
    public override func sceneDidLoad() {
        ...
        //sequences and functions setup
        cursorSequence1 = SKAction.sequence([pause2second, cursorWait, cursorFadeIn, cursorWait, cursorFadeOut])
        
        cursorSequence2 = SKAction.sequence([pause4second, cursorWait, cursorFadeIn, cursorWait, cursorFadeOut])
        
        cursorSequence3 = SKAction.sequence([pause7second, cursorWait, cursorFadeIn, cursorWait, cursorFadeOut])
    ...
    func moveHearts() {
        for heart in hearts {
            ...
            case "heart2"?:
                let path = UIBezierPath()
                path.move(to: CGPoint(x: 0, y: 0))
                path.addCurve(to: CGPoint(x: -(heart.position.x - people[0].position.x) + 10, y: -(heart.position.y - people[0].position.y) + 300), controlPoint1: CGPoint(x: -100, y: 50), controlPoint2: CGPoint(x: -midpoint.x, y: midpoint.y))
            ...
            case "heart3"?:
                let path = UIBezierPath()
                path.move(to: CGPoint(x: 0, y: 0))
                path.addCurve(to: CGPoint(x: -(heart.position.x - people[2].position.x), y: -(heart.position.y - people[2].position.y) + 589), controlPoint1: CGPoint(x: -100, y: 0), controlPoint2: CGPoint(x: -midpoint.x, y: midpoint.y))
    ...
    func dropHeart(_ heart: SKSpriteNode){
        ...
        case "heart1"?:
            ...
            let fadeInSequence = SKAction.sequence([pause2second, isFadingInChange])
            self.run(fadeInSequence)
